            ...
            <div className="max-w-7xl mx-auto px-7 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    <div className="hidden md:block text-left">
                        ...
                        <p className="font-semibold text-sm"><Link href="/login">LOG IN</Link> / <Link href="/register">REGISTER</Link></p>
                    </div>
                    ...
                    <Link href="/cart">
                        <div className="flex items-center gap-4 cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <span className="absolute -top-3 -right-3 bg-teal-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                                    {cart?.items?.length || 0}
                                </span>
                            </div>
